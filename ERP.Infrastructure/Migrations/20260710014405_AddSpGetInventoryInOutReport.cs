...
{
    /// <inheritdoc />
    public partial class AddSpGetInventoryInOutReport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"
CREATE PROCEDURE sp_GetInventoryInOutReport
...
";
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_GetInventoryInOutReport");
        }
    }
}
