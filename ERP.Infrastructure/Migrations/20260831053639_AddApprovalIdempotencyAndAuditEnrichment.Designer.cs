...
namespace ERP.Infrastructure.Migrations
{
    ...
    [Migration("20260831053639_AddApprovalIdempotencyAndAuditEnrichment")]
    partial class AddApprovalIdempotencyAndAuditEnrichment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CommandScope")
                        .IsRequired()
                        .HasMaxLength(160)
                    ...
                    b.HasIndex("UserId", "CommandScope", "KeyHash")
                        .IsUnique();
            ...
            modelBuilder.Entity("ERP.Domain.Entities.InventoryStock", b =>
                {
                    ...
                    b.ToTable("InventoryStocks", null, t =>
                        {
                            t.HasCheckConstraint("CK_InventoryStocks_Reservation", "[ReservedQuantity] >= 0 AND [Quantity] >= [ReservedQuantity]");
                        });
                });
            ...
            modelBuilder.Entity("ERP.Domain.Entities.StockReservation", b =>
                {
                    ...
                    b.HasIndex("SourceType", "SourceId", "ProductId")
                        .IsUnique()
                        .HasFilter("[SourceId] IS NOT NULL");

                    b.HasIndex("ProductId", "WarehouseId", "Status", "ExpiresAt");
